...
Mit der qualitativen Inhaltsanalyse wurden Codes erstellt und nach der Häufigkeit ihres Vorkommens sortiert, wobei besonders häufiges Auftreten auf die Funktion eines Momentes im Diskurs hinweist. Die Codes "`Sorgearbeit"', "`Mutter"', "`Berufstätigkeit"', "`Ehe"' und "`Pflichtbewusstsein"' konnten als Momente des Knotenpunktes "`Frau sein"' ausgemacht werden. "`Berufstätigkeit"' kommt 1941 neu hinzu, die anderen Momente treten konstant auf. Dies lässt nicht - wie angenommen - darauf schließen, dass sich der Diskurs um Weiblichkeit mit Ausbruch des Krieges grundlegend verändert hat, denn dazu hätten sich die ausgemachten Momente vor und nach Kriegsbeginn stärker voneinander unterscheiden müssen. 

Um die Struktur des Diskurses genauer untersuchen zu können und einen Einfluss des neu hinzukommenden Momentes zu erkennen, wurde im Anschluss eine Simultanzanalyse der ausgemachten Momente für die Jahre 1936 und 1941 durchgeführt. Aus dieser geht hervor, dass es sich bei allen Momenten tatsächlich um solche handelt und nicht etwa um weitere Knotenpunkte im Diskurs, da keines von ihnen mehrere andere Codes an sich bindet. Die Momente "`Ehe"' und "`Mutter"' weisen nach Kriegsbeginn häufiger Simultanzen auf als zuvor und binden außerdem den Code "`Häuslichkeit"' stärker an sich. "`Berufstätigkeit"' hingegen zeigt kaum Simultanzen mit "`Ehe"' und "`Mutter"'. Dies lässt darauf schließen, "`Ehe"' und "`Mutter"' hier eine Äquivalenzkette bilden und sich nach Kriegsausbruch zwei antagonisierende Identifikationsangebote für Frauen entwickelten: Zum einen das der heimischen, verheirateten Mutter, zum anderen das der jungen, unverheirateten berufstätigen Frau. 

Zu beobachten ist außerdem, dass "`Berufstätigkeit"' und "`Sorgearbeit"' einen schwachen Zusammenhang aufweisen. Es ist zu vermuten, dass Frauen nicht zwingend soziale Berufe ergreifen mussten, dies jedoch häufig geschah und gern gesehen war. Verwunderlich scheint, dass "`Sorgearbeit"' kaum Simultanzen mit "`Ehe"' und "`Mutter"' aufweist, aber "`Organisation, Selbständigkeit"' an sich bindet. 
%muss ich noch eine Erklärung für finden

"`Pflichtbewusstsein gegenüber der Nation"' bindet keine anderen Codes an sich und zeigt auch kaum Simultanzen. Es scheint als Knotenpunkt einen anderen Diskurs zu strukturieren und für die Identifikation als Frau nicht ausschlaggebend, aber auch nicht irrelevant zu sein. Dies schient im Kontext des Nationalsozialismus logisch, da Nationalismus und damit Pflichtbewusstsein gegenüber Deutschland als wichtiger Bestandteil der Ideologie gilt und wesentlich zur Identifikation als Deutsche\_r nicht nur für Frauen beiträgt.

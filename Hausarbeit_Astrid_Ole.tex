...
\captionsetup{format=plain, indention=0cm, justification=raggedright, singlelinecheck=off, font={small, singlespacing}}
...
\begin{table}[!hb] %versucht das Bild, an einer möglichst günstigen Stelle einzufügen

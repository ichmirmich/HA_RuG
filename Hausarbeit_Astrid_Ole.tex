...
%\usepackage{float}
%\usepackage[section]{placeins}																%Paket, um Grafiken davon abzuhalten, außerhalb bestimmter grenzen zu floaten [section]: verbietet gleiten außerhalb der Section
\usepackage{caption}																			%zum Formatieren der Bildunterschriften
...
\title{Weiblichkeitsvorstellungen \\im Nationalsozialismus}
...
\noindent Die \textit{differenzierende Simultanz} (quantitativ und qualitativ schwach) verweist auf Momente, die entweder hauptsächlich in anderen Diskursen gebunden werden oder sich im Feld der \textit{Diskursivität} befinden.
...
Durch die Analyse ausgewählter Artikel der NS-Frauenwarte konnten nicht nur die Knotenpunkte des leeren Signifikanten "`Frau sein"' erkannt werden, sondern auch ihre Beziehung untereinander. Irina Scheidgens These, dass mit Ausbruch des 2. Weltkrieges ein neues Frauenbild aufkam -- zusätzlich zum Bild der verheirateten Mutter, das der berufstätigen Frau -- konnte auch für ein zweites Medium bestätigt werden. Ferner konnte durch die Simultanzanalyse erkannt werden, dass es sich hierbei um differente Identitätsangebote handelt. Somit hat sich zwar der Diskurs um Weiblichkeit verändert, allerdings nicht vollständig verschoben. Da sich die zwei Identifikationsmöglichkeiten jedoch gegenseitig ausschließen, muss diese neu aufgetretene Differenz irgendwie ausgehandelt werden. Wir können an dieser Stelle keine abschließende Antwort geben, die Vermutung liegt jedoch nahe, dass sich mit dem Bild der Berufstätigkeit jüngere und vor allem unverheiratete Frauen identifizierten und sie sich mit Beginn der Ehe wieder dem "`klassischen"' Bild zuwandten. Berufstätigkeit wird dabei regelmäßig mit Sorgearbeit in Verbindung gebracht, was noch einmal auf eine wenig radikale Veränderung der Diskursstruktur verweist.

Abschließend kann aber festgehalten werden, dass eine größer angelegte Studie zur Beantwortung der Forschungsfrage sinnvoll ist. Die vorliegende Analyse kann dazu als Grundlage dienen, erfüllt jedoch nicht alle notwendigen Gütekriterien, welche an eine qualitative Inhaltsanalyse gestellt werden. Mayring schlägt mit Verweis auf Krippendorff spezifisch auf die Methode zugeschnittene Gütekriterien vor (\cite[vgl.][Kap. 7.2]{mayring_qualitative_2010}). Vor allem durch gleichzeitiges Codieren mehrerer Forschender und regelmäßigen Austausch untereinander kann die Reliabilität der Forschung gesteigert werden (\cite[vgl.][117;120-121]{mayring_qualitative_2010}). Zusätzlich sollte die Stichprobe, um als repräsentativ zu gelten, vergrößert werden, auch sollten mehr Jahrgänge analysiert werden. Zu erwarten wäre, dass sich die Diskursstruktur deutlicher herausbildet und dass sich die Verbindungen der Knotenpunkte untereinander, aber auch zu ihren Momenten stärker abzeichnen. Außerdem sollten die Simultanzen eindeutiger identifizierbar sein, da quantitative "`Ausreißer"' durch die größere Anzahl an Findings ausgeglichen werden.

Aus den Ergebnissen dieser Arbeit folgen zwei weitergehende Fragestellungen. Zum einen wurde mit der \textit{NS-Frauenwarte} direktes Propagandamaterial der NSDAP untersucht; es wurde sich damit auf einen Diskursausschnitt der Führungselite bezogen. Um zu ergründen, inwieweit sich diese Identifikationsangebote innerhalb der Bevölkerung durchgesetzt haben, wäre eine Analyse von Lokalzeitungen oder gar Tagebucheinträgen vonnöten. Zum anderen wäre es interessant zu untersuchen, wie sich das Bild der berufstätigen Frau zeitlich entwickelt. Kann es sich als mögliche Identität für Frauen durchsetzen oder gar andere Indentifikationsangebote verdrängen? Irina Scheidgen stellt in ihrer Analyse von Spielfilmen zu der Zeit fest, dass die Protagonistinnen ihre Selbständigkeit zu Ende der Filme immer zugunsten einer traditionelleren Rolle wieder aufgeben müssen. "`Die Kriegszeit stellte für die Nationalsozialisten eine Ausnahmezeit dar, in der kein neuer, dauerhafter Entwurf einer emanzipierten Frauenrolle begründet werden sollte"' (\cite[278]{scheidgen_frauenbilder_2015}). Diese Frage stellt sich gerade im Hinblick auf das fordistische Wirtschaftsmodell nach 1945, welches Frauen wieder vollständig in die Hausarbeit drängt. Dementsprechend wäre zu erwarten, dass die Kategorie \textit{Berufstätigkeit} im Diskurs wieder eine marginale Rolle einnimmt. Außerdem wäre in diesem Zusammenhang der Diskurs um die "`Trümmerfrauen"' zu untersuchen. Die feministische Forschung konnte schon in der Frage des Frauenbildes im Nationalsozialismus zeigen, dass die Antwort keinesfalls so einfach ausfällt, wie die Klischees vermuten lassen. Eine Untersuchung der Diskursstruktur von \textit{Weiblichkeit} in der Nachkriegszeit ist also wünschenswert und sicherlich aufschlussreich.
...
Kodiert werden alle Aussagen, die berufstätige Frauen beschreiben, oder über Berufe schreiben, die von Frauen ergriffen werden. Um Berufstätigkeit von ehrenamtlichen Tätigkeiten zu unterscheiden, wurden als Anforderungen an Berufe gesetzt, dass sie eine Ausbildung benötigen und vergütet werden.\\
...
Ankerbeispiel: "`Immer spürt dann die echte Frau instinktmäßig, was sie sagen, tun, unternehmen muß, um die gestörte Eintracht zu bewahren"' (\cite[36]{weinhandl_wie_1941}).

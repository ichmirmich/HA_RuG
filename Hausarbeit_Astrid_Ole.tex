...
\captionsetup{format=plain, indention=0.5cm, justification=raggedright, singlelinecheck=off, font=small}
...
\begin{figure}[!hb] %versucht das Bild, an einer möglichst günstigen Stelle einzufügen
\caption{Simultanzen der Kategorien \textit{Sorgearbeit, Mutter, Ehe, Berufstätigkeit} und \textit{Pflichtbewusstsein} mit allen anderen Kategorien}
\centering
<<<<<<< HEAD
...
=======
\includegraphics[width=0.9\linewidth]{simultanzenuber}% die Breite des eingefügten Bildes entspricht 80% einer Zeilenlänge
...
%\captionbelow{AV = Absolutes Vorkommen eines Codes im gesamten Sample der Zeitung\\SI = Simultanzen: Quantität des simultanen Vorkommens mit anderen Codes\\Die Simultanz wird dann grau markiert, wenn der Vergleichscode mindestens zu 50\% seines absoluten Vorkommens (AV) mit dem Ausgangscode überlappt.}
>>>>>>> origin/master
\end{figure}
